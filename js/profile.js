...
if (user) {
  ...
  if (user.displayName == 'Garima') {
    verifiedtick.innerHTML = `
    <h4 id="user-name" style="color:purple;">Garima Upadhayay</h4>
        <h4 id="tickk" class="bx bx-check" ></h4>
        
    `;
    document.getElementById('role').innerHTML = "Principal"
  }
  else if (user.displayName == 'Shaurya001') {
    verifiedtick.innerHTML = `
    ...
    document.getElementById('role').innerHTML = "Developer/Ownwe/Admin"
  }
  ...
  else if (user.displayName == 'Lakshmi') {
    verifiedtick.innerHTML = `
    <h4 id="user-name" style="color:red;">Lakshmu Mam</h4>
        <h4 id="tickk" class="bx bx-check" ></h4>
